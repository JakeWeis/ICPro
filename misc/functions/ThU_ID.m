function [IDC,dIDC] = ThU_ID(SpikePar,WtPar,ThU,dThU,OUT)
...
IDC.Th230 = 1/ThMassRatio .* SpikePar.Th229CY .* ...
    ...
    ((SpikePar.Th229RY - ThU.Sample.R229_230(ThUSampleInd))./(ThU.Sample.R229_230(ThUSampleInd) - SpikePar.Th229RX)) .* ...
    1/(SpikePar.Th229RY + 1) * 10^-6;
dIDC.Th230 = IDC.Th230 .* sqrt((dscale./WtPar.m_ThBC(IDC.TEMatchUpInd)).^2 + (dscale./WtPar.m_sed(IDC.TEMatchUpInd)).^2 + (dThU.Sample.R229_230_cMB(ThUSampleInd)./ThU.Sample.R229_230_cMB(ThUSampleInd)).^2*2);
...
IDC.U234 = 1/UMassRatio .* SpikePar.U236CY .* ...
    ...
    ((SpikePar.U236RYb - ThU.Sample.R236_234(ThUSampleInd))./(ThU.Sample.R236_234(ThUSampleInd) - SpikePar.U236RX)) .* ...
    1/(SpikePar.U236RYb + 1) .* ...
    10^-6;
dIDC.U234 = IDC.U234 .* sqrt((dscale./WtPar.m_UBC(IDC.TEMatchUpInd)).^2 + (dscale./WtPar.m_sed(IDC.TEMatchUpInd)).^2 + (dThU.Sample.R236_234_cMB(ThUSampleInd)./ThU.Sample.R236_234_cMB(ThUSampleInd)).^2*2);
